...
function Hero() {
  return (
    ...
    <div  className="relative flex flex-col sm:flex-row h-auto sm:h-[50rem] w-full items-center justify-center bg-white dark:bg-black py-8 sm:py-0">
      ...
      <div
        className="flex flex-col sm:flex-row items-center justify-center gap-4 relative z-20 bg-gradient-to-b from-neutral-200 to-neutral-500 bg-clip-text py-4 sm:py-8 text-xl sm:text-7xl font-bold text-transparent">
         ...
         <Image 
          ...
          <div className="flex flex-col items-center justify-center sm:items-center">
            <h1 className=" text-3xl sm:text-7xl">Hi I am Abhishek</h1>
